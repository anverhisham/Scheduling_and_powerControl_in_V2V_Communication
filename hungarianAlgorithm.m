...
%
% [ASSIGN,COST] = hungarianAlgorithm(COSTMAT) returns the optimal column indices,
...
%{
[assignment,cost] = hungarianAlgorithm(magic(5));
...
% http://csclab.murraystate.edu/bob.pilgrim/445/hungarianAlgorithm.html
