...
%%%%%%%%%%%%%%%%%% This file contains DOWNLOADED-FUNCTIONS(df), which are conveniently put into a single file %%%%%%%%%%%%%%% 
%
%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
%% - http://se.mathworks.com/matlabcentral/fileexchange/31532-pack---unpack-variables-to---from-structures-with-enhanced-functionality/content/html/v2struct.html
%% v2struct
